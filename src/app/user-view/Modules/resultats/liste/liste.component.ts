...
export class ListeComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,private evenementService:EvenementsService,private pubService:PublicitesService,private router: Router,private msg: NzMessageService,private dataProvider:ProviderService) { }
url?:string
